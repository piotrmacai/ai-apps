    ...
    >
      ...
      >
        ...
        <div className="flex justify-center gap-4">
            <button 
              onClick={() => downloadImage(imageUrl, `ai-product-shot-${Date.now()}`)}
              className="bg-white/20 text-white rounded-full px-6 py-3 text-base font-semibold hover:bg-white/30 transition-colors flex items-center gap-2"
            >
              <DownloadIcon />
              {t('downloadImage')}
            </button>
